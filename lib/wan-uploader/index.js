...
import { isImageFile, chooseFile, isVideoFile } from '../common/utils/file';
export const emits = [
  'error',
  'before-read',
  'oversize',
...
export const props = Object.assign(
  Object.assign(
    Object.assign(
      Object.assign(Object.assign({}, imageProps), videoProps),
      mediaProps
    ),
    messageFileProps
  ),
...
export function setup(props, context) {
  ...
  const onAfterRead = (file) => {
    ...
    const oversize = Array.isArray(file)
      ...
      : file.size > maxSize;
    if (oversize) {
      emit('oversize', Object.assign({ file }, getDetail()));
      return;
    }
    if (typeof afterRead === 'function') {
      afterRead(file, getDetail());
    }
    emit('after-read', Object.assign({ file }, getDetail()));
  };
