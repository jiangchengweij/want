<template>
	<demo-block title="基础用法" padding>
		<w-button type="primary" @click="toggleActionSheet1">弹出菜单</w-button>
		<w-action-sheet
			:show="state.show1"
			:actions="state.action1"
			@close="toggleActionSheet1"
		/>
	</demo-block>

	<demo-block title="选项状态" padding>
		<w-button type="primary" @click="toggleActionSheet2">弹出菜单</w-button>
		<w-action-sheet
			:show="state.show2"
			:actions="state.action2"
			@close="toggleActionSheet2"
		/>
	</demo-block>

	<demo-block title="展示取消按钮" padding>
		<w-button type="primary" @click="toggleActionSheet3">弹出菜单</w-button>
		<w-action-sheet
			:show="state.show3"
			:actions="state.action1"
			cancel-text="取消"
	...
	<demo-block title="展示描述信息" padding>
		<w-button type="primary" @click="toggleActionSheet4">弹出菜单</w-button>
		<w-action-sheet
			:show="state.show4"
			:actions="state.action1"
	...
	<demo-block title="展示标题栏" padding>
		<w-button type="primary" @click="toggleActionSheet5">弹出菜单</w-button>
		<w-action-sheet
			:show="state.show5"
			title="标题"
	...
	<demo-block title="微信开放能力" padding>
		<w-button type="primary" @click="toggleActionSheet6">弹出菜单</w-button>
		<w-action-sheet
			:show="state.show6"
			title="标题"
			@close="toggleActionSheet6"
			:actions="state.action6"
