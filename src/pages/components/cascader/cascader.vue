<template>
	<demo-block title="基础用法">
	  <w-field
	    :modelValue="state.baseState.result"
	    is-link
	    readonly
	    label="地区"
	...
	<demo-block title="自定义颜色">
	  <w-field
	    :modelValue="state.customColorState.result"
	    is-link
	    readonly
	    label="地区"
	    :placeholder="state.selectArea"
	  ...
	  />
	  <w-popup
	    :show="state.customColorState.show "
	    round
	    position="bottom"
	  >
	    <w-cascader
	...
	<demo-block title="异步加载选项">
	  <w-field
	    :modelValue="state.asyncState.result"
	    is-link
	    readonly
	    label="地区"
	    :placeholder="state.selectArea"
	...
	<demo-block title="自定义字段名">
	  <w-field
	    :modelValue="state.customFieldState.result"
	    is-link
	    readonly
	    label="地区"
	    :placeholder="state.selectArea"
...
<script setup>
import { isDef, isObj } from '@/uni_modules/want/components/utils/validator'
