...
export const emits = ['scroll'] as const;
export const props = {
  zIndex: {
    type: Number,
    default: 99
...
export function setup(
  ...
  const { emit } = context;
  let _contentObserver: UniNamespace.IntersectionObserver | null = null;
  let _containerObserver: UniNamespace.IntersectionObserver | null = null;
